...
package me.neilellis.dollar.relproxy.impl.jproxy.shell;
...
import me.neilellis.dollar.relproxy.impl.jproxy.core.clsmgr.SourceScriptFile;
...
public class JProxyShellScriptFileImpl extends JProxyShellImpl {
    ...
    public void init(@NotNull String[] args) {
        ...
        if (!scriptFile.exists()) { throw new RelProxyException("File " + args[0] + " does not exist"); }
    ...
    protected void fixLastLoadedClass(
        ...
        // Esto es esperable cuando especificamos un classFolder en donde está ya compilado el script lanzador y es
        // más actual que el fuente
