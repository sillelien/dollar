...
import me.neilellis.dollar.relproxy.impl.jproxy.JProxyDefaultImpl;
...
public class JProxy {
    ...
    /**
     * Creates a proxy object using {@code java.lang.reflect.Proxy} based on the provided Java object and the class of
     * the implemented Java interface.
     *
     * <p>If {@code JProxy} has been configured and is enabled this method returns a {@code java.lang.reflect.Proxy}
     * object implementing instead of the original object provided. Methods called in proxy object are received by
     * {@code JProxy} and forwarded to the original object, if source code managed by {@code JProxy} has been changed,
     * the class of the original object is reloaded based on the new source and the original object is recreated with
     * the new class and fields are re-set in the new object, then the method is called on the new original object.</p>
     *
     ...
     *
     * @return true if source change detection has been stopped, false if it is already stopped or {@code JProxy} is not
