...
import me.neilellis.dollar.relproxy.impl.jproxy.shell.JProxyShellInteractiveImpl;
...
public class JProxyShellProcessor {
    public static final int
            LINE_OFFSET =
            2;
    // El índice en codeBuffer + este valor = al valor de la línea que se muestra al usuario, hay que tener
    // en cuenta que contamos desde uno y la primera línea es siempre vacía
    ...
    public void loop() {
        ...
        Scanner
                ...
                new Scanner(System.in,
                            encoding.name());  // No encuentro nada interesante en http://docs.oracle
        // .com/javase/6/docs/api/java/io/Console.html
        System.out.print(">");
        while (true) {
