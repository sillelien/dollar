...
public class WindowUnicodeKeyboard extends Keyboard {
    ...
    public boolean type(char character) {
        ...
        // En Windows usar mintty porque usando la consola de MSYS por sí misma, que es realmente la de Windows, hay
        // problemas con el set de caracteres, pues sería Cp1252 para Java pero Cp850 para la consola y salen mal por
        // tanto los caracteres no ASCII
