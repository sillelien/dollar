...
public abstract class Keyboard {
    ...
    @NotNull public static Keyboard create(Charset cs) {
        ...
        if (osName.contains("windows")) { return new WindowUnicodeKeyboard(cs); } else if (osName.contains("os x")) {
    ...
    public boolean type(char character) {
        ...
        // He quitado todos los símbolos que son susceptibles de cambiar según el teclado pues hay que acertar
        // exactamente la combinación de teclas del teclado
