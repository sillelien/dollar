...
package me.neilellis.dollar.script.relproxy.impl.jproxy.core.clsmgr;

import me.neilellis.dollar.script.relproxy.impl.jproxy.JProxyUtil;
import me.neilellis.dollar.script.relproxy.impl.jproxy.core.JProxyImpl;
import me.neilellis.dollar.script.relproxy.impl.jproxy.core.clsmgr.comp.JProxyCompilerContext;
import me.neilellis.dollar.script.relproxy.impl.jproxy.core.clsmgr.comp.JProxyCompilerInMemory;
import me.neilellis.dollar.script.relproxy.jproxy.JProxyDiagnosticsListener;
            ...
            // el autosalvado de .class tenemos que eliminar en ese caso
        {
            ...
            for (ClassDescriptorSourceUnit sourceFile : sourceRegistry.getClassDescriptorSourceFileColl()) {
                ...
                reloadSource(sourceFile,
                             true); // Ponemos detectInnerClasses a true porque son archivos fuente que posiblemente nunca se hayan tocado desde la carga inicial y por tanto quizás se desconocen las innerclasses
            }
        }
