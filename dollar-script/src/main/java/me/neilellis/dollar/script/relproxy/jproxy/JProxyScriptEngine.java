...
public interface JProxyScriptEngine extends ScriptEngine {
    /**
     * This method is the same as {@link me.neilellis.dollar.script.relproxy.jproxy.JProxy#create(Object, Class)} but
     * applied to
     * this {@code JProxyScriptEngine}
     *
    ...
    /**
     * This method is the same as {@link me.neilellis.dollar.script.relproxy.jproxy.JProxy#start()} but applied to this {@code
     * JProxyScriptEngine}
     *
    ...
    /**
     * This method is the same as {@link me.neilellis.dollar.script.relproxy.jproxy.JProxy#stop()} but applied to
     * this {@code JProxyScriptEngine}
     *
