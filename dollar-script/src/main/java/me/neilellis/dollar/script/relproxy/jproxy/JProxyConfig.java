...
package me.neilellis.dollar.script.relproxy.jproxy;

import me.neilellis.dollar.script.relproxy.RelProxyOnReloadListener;
...
public interface JProxyConfig {
     ...
     *
     * <p>This setting is optional and the folder must be included in Java classpath because the objective is to
     * avoid recompiling.</p>
     *
     ...
     * detection/reload and original objects are returned
     * instead of proxies, performance penalty is zero. Setting to false is recommended in production whether source
     * code change detection/reload is not required.</p>
     *
     ...
     *
     * <p>Structure of the source tree must be the same as a JavaSE application, the only difference is shell
     * scripts, shell scripts must be
