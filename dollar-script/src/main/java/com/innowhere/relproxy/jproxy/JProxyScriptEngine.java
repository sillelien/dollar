...
public interface JProxyScriptEngine extends ScriptEngine {
    /**
     * This method is the same as {@link com.innowhere.relproxy.jproxy.JProxy#create(Object, Class)} but applied to
    ...
    /**
     * This method is the same as {@link com.innowhere.relproxy.jproxy.JProxy#start()} but applied to this {@code
     * JProxyScriptEngine}
     *
    ...
    /**
     * This method is the same as {@link com.innowhere.relproxy.jproxy.JProxy#stop()} but applied to this {@code JProxyScriptEngine}
     *
