...
//        ScriptEngine engine = manager.getEngineByName("j");
        ...
        code.append(
                "com.sillelien.dollar.api.var in = (com.sillelien.dollar.api.var)context.getAttribute(\"in\",javax" +
                ".script.ScriptContext.ENGINE_SCOPE); \n");
        code.append(
                "com.sillelien.dollar.script.api.Scope scope = (com.sillelien.dollar.script.api.Scope)context" +
                ".getAttribute(\"scope\",javax.script.ScriptContext.ENGINE_SCOPE); \n");
        code.append(" com.sillelien.dollar.api.var out = com.sillelien.dollar.api.DollarStatic.$void();\n");
