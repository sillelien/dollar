...
The return type will be of type `var` and is stored in the variable `out`. The Java snippet also has access to the scope (dollar.internal.runtime.script.Scope) object on which you can get and set Dollar variables.
