...
public enum ErrorType {
    ...
    IO, NUMBER_FORMAT_ERROR, BAD_REGEX, STRING_TOO_LARGE, MULTIPLIER_TOO_LARGE, VALIDATION, INVALID_QUEUE_OPERATION, INVALID_OBJECT_OPERATION, INVALID_SEQUENCE_OPERATION, VOID_FAILURE
}
