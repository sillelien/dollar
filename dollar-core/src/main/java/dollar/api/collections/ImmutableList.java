...
public final class ImmutableList<V> implements Iterable<V> {
    ...
    @NotNull
    public static <V> ImmutableList<V> copyOf(@NotNull List<V>... lists) {
    ...
    @NotNull
    public static <V> ImmutableList<V> copyOf(@NotNull ImmutableList<V>... lists) {
        List<V> list = new ArrayList<>();
    ...
    @NotNull
    public <T> T[] toArray(@NotNull T[] a) {return list.toArray(a);}
}
