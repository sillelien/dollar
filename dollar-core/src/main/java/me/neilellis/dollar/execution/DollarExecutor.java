...
/**
 * The interface for all Execution plugins to implement. The plugin mechanism allows non thread based solutions to be
 * used or just the standard Java Executors framework. Which ever is appropriate.
 *
