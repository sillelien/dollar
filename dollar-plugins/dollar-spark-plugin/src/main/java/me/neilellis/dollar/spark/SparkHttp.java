 ...
 */
public class SparkHttp extends SparkBase implements DollarHttp {


  @Override public DollarHttp copy() {
    return this;
  }

  @NotNull @Override public DollarHttp route(@NotNull String method, @NotNull String path,
...
//        DollarStatic.log("Adding route for "+path);
    SparkBase.addRoute(method, SparkBase.wrap(path, route));
    return this;
  }
}
