...
[ ![Binary Distribution](download.png) ](https://bintray.com/sillelien/binary/download_file?file_path=dollar-0.3.2090.tgz)
...
```bash
alias dollar="docker run sillelien/dollarscript-headless:0.3.2090"
 ```
