...
```bash
alias ds="docker run sillelien-docker-docker.bintray.io/dollarscript-headless:0.3.1358"
 ```
...
```bat
    docker run sillelien-docker-docker.bintray.io/dollarscript-windows:0.3.1358 <args>
```
