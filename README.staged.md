...
[ ![Binary Distribution](download.png)](https://bintray.com/sillelien/binary/download_file?file_path=dollar-0.3.2204.tgz)
...
Download the [distribution](https://bintray.com/sillelien/binary/download_file?file_path=dollar-0.3.2204.tgz) then

```bash
    tar -zxvf dollar-0.3.2204.tgz
...
The bintray page for the distribution binary is here: [ ![Download](https://api.bintray.com/packages/sillelien/binary/dollar/images/download.svg?version=0.3.2204) ](https://bintray.com/sillelien/binary/dollar/0.3.2204/link)
